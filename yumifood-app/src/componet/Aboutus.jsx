    ...
    <div className="text-gray-600 body-font w-[80%] mx-auto mt-[100px]">
      <div className="px-[16px]">
        ...
        <p className="mb-8 leading-relaxed text-[20px]">
          ...
          together meticulous infomation for our customers, We enable them to
      ...
      <div className='container mx-auto flex px-5 py-24 md:flex-row flex-col items-center'>
        ...
        <div className='lg:max-w-lg lg:w-full md:w-1/2 w-5/6'>
          <img className='object-cover object-center rounded-md' alt='hero' src='https://b.zmtcdn.com/web/about/a7b0a36d5107f3590895981dab2eeac31563208212.jpeg?output-format=webp'/>
        </div>
      </div>
    </div>
  )
